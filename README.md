...
**Sodash** is a sh-compatible command language interpreter that executes commands read from the standard input or from a file.
...
* Chukwujama Chibuzor <[Jamaal50](https://github.com/Jamaal50)>
* Anosike Onyedikachi <[dikachitheman](https://github.com/dikachitheman)>
